...
namespace Diary_Mei
{
    public partial class Editor_Contact : Form
    {
        ...
        private void Clear_Text(Control The_Control)//清除文本框内容
        {
